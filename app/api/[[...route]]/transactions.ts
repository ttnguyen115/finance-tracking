...
const app = new Hono()
    .get(
        ...
        async (ctx) => {
            ...
            const defaultFrom = subDays(defaultTo, AMOUNT_30_DAYS);
    ...
    .post("/", clerkMiddleware(), zValidator("json", insertTransactionSchema.omit({ id: true })), async (ctx) => {
        const auth = getAuth(ctx);
